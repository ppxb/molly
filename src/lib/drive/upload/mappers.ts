import type { FileCompleteResponse, FileSearchItem } from '@/lib/drive/api'
...
import { resolveTargetFolderID, resolveTargetFolderPath } from '@/lib/drive/upload/helpers'
...
export function mapSearchItemToUploadedFile(item: FileSearchItem, input: TransferFileInput): DriveFileRecord {
  return {
    id: item.file_id,
    fileName: item.name,
