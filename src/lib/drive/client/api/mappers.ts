import type {
  ...
  UploadFolderRecord,
  UploadedFileRecord
} from '@/lib/drive/client/api/types'
...
export function buildBreadcrumbs(pathItems: FileGetPathItem[]): UploadBreadcrumbItem[] {
...
export function mapFolderItem(item: FileListItem, currentPath: string): UploadFolderRecord {
...
export function mapFileItem(item: FileListItem, currentPath: string): UploadedFileRecord {
