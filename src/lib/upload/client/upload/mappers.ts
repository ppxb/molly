import type { FileCompleteResponse, FileSearchItem } from '@/lib/upload/client/api'
...
import { resolveTargetFolderID, resolveTargetFolderPath } from '@/lib/upload/client/upload/helpers'
