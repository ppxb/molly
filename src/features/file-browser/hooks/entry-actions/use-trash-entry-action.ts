...
import { getErrorMessage, recycleBinTrashRequest } from '@/lib/upload/client/api'
...
interface UseTrashEntryActionInput extends BrowserEntriesSnapshot {
  currentFolderIdRef: MutableRefObject<string>
  loadEntries: (folderId: string) => Promise<void>
}

export function useTrashEntryAction({
  currentFolderIdRef,
  loadEntries,
  currentPath,
  breadcrumbs,
